<template>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <router-link tag='li' class="nav" active-class="active" to="/home"><a href="javascript:void(0)"><i class="fa fa-link"></i> <span>首页</span></a></router-link>
        <router-link tag="li" class="nav" active-class="active" to="/position"><a href="javascript:void(0)"><i class="fa fa-link"></i> <span>职位管理</span></a></router-link>
        <!-- <li class="treeview">
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
    <section class="content" id="router-view">
